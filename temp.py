...
class Game:
    ...
    def check_pattern(self, board, pattern, player_val):
        """Vérifie la présence d'un pattern sur le plateau"""
    ...
    def evaluate_board(self, board, joueur):
        """Évaluation améliorée du plateau"""
    ...
    def get_best_moves(self, board, joueur, nb_Turn, top_n=5):
            """Sélection améliorée des meilleurs coups"""
    ...
    def blocks_win(self, board, move, opponent):
        """Vérifie si un coup bloque une victoire adverse"""
    ...
    def minimax(self, board, joueur, nb_Turn, depth=3):
        ...
        best_move = moves[0]
        board_hash = str(board)  # Hash simple pour la table de transposition
